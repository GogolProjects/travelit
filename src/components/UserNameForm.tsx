        ...
        onError(err){
            if(err instanceof AxiosError){
                if(err.response?.status === 409){
                    return toast({
                        title: 'Traveller alerady exists',
                        description: ' Please choose a diffrent traveller name.',
                        variant: 'destructive',
                    })
                }
    ...
    <form onSubmit={handleSubmit((e) => updateUsername(e))}>
        <Card>
            <CardHeader>
                ...
                <CardDescription className='text-slate-800 pt-1'>
                    Please enter Your traveller name
                </CardDescription>
            </CardHeader>
            <CardContent>
